...
|---|---|---|---|---|---|
| nginxproxy_additional_http_config_files | <p>A list of additional configuration files to include in the HTTP server block.</p><p>See **trippsc2.nginx.oss** role for formatting information.</p> | list | no |  |  |
